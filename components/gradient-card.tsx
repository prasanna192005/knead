...
const GradientCard: React.FC<GradientCardProps> = ({
  title = "Feature Title",
  description = "Description of the feature or product.",
  icon,
  linkText = "Learn More",
  linkHref = "#",
  colorScheme = 'blue',
  ...
  const colorSchemes = {
    red: {
      gradient1: 'radial-gradient(ellipse at bottom right, rgba(255, 99, 71, 0.7) -10%, rgba(139, 0, 0, 0) 70%), radial-gradient(ellipse at bottom left, rgba(220, 20, 60, 0.7) -10%, rgba(139, 0, 0, 0) 70%)',
      gradient2: 'radial-gradient(circle at bottom center, rgba(178, 34, 34, 0.7) -20%, rgba(139, 0, 0, 0) 60%)',
      shadow: isHovered
        ? "0 0 20px 4px rgba(255, 99, 71, 0.9), 0 0 30px 6px rgba(139, 0, 0, 0.7), 0 0 40px 8px rgba(220, 20, 60, 0.5)"
        : "0 0 15px 3px rgba(255, 99, 71, 0.8), 0 0 25px 5px rgba(139, 0, 0, 0.6), 0 0 35px 7px rgba(220, 20, 60, 0.4)",
    },
    blue: {
      gradient1: 'radial-gradient(ellipse at bottom right, rgba(172, 92, 255, 0.7) -10%, rgba(79, 70, 229, 0) 70%), radial-gradient(ellipse at bottom left, rgba(56, 189, 248, 0.7) -10%, rgba(79, 70, 229, 0) 70%)',
      gradient2: 'radial-gradient(circle at bottom center, rgba(161, 58, 229, 0.7) -20%, rgba(79, 70, 229, 0) 60%)',
      shadow: isHovered
    ...
    green: {
      gradient1: 'radial-gradient(ellipse at bottom right, rgba(50, 205, 50, 0.7) -10%, rgba(0, 100, 0, 0) 70%), radial-gradient(ellipse at bottom left, rgba(144, 238, 144, 0.7) -10%, rgba(0, 100, 0, 0) 70%)',
      gradient2: 'radial-gradient(circle at bottom center, rgba(34, 139, 34, 0.7) -20%, rgba(0, 100, 0, 0) 60%)',
      shadow: isHovered
        ? "0 0 20px 4px rgba(50, 205, 50, 0.9), 0 0 30px 6px rgba(0, 100, 0, 0.7), 0 0 40px 8px rgba(144, 238, 144, 0.5)"
        : "0 0 15px 3px rgba(50, 205, 50, 0.8), 0 0 25px 5px rgba(0, 100, 0, 0.6), 0 0 35px 7px rgba(144, 238, 144, 0.4)",
    },
    yellow: {
      gradient1: 'radial-gradient(ellipse at bottom right, rgba(255, 215, 0, 0.7) -10%, rgba(184, 134, 11, 0) 70%), radial-gradient(ellipse at bottom left, rgba(255, 255, 224, 0.7) -10%, rgba(184, 134, 11, 0) 70%)',
      gradient2: 'radial-gradient(circle at bottom center, rgba(218, 165, 32, 0.7) -20%, rgba(184, 134, 11, 0) 60%)',
      shadow: isHovered
        ? "0 0 20px 4px rgba(255, 215, 0, 0.9), 0 0 30px 6px rgba(184, 134, 11, 0.7), 0 0 40px 8px rgba(255, 255, 224, 0.5)"
        : "0 0 15px 3px rgba(255, 215, 0, 0.8), 0 0 25px 5px rgba(184, 134, 11, 0.6), 0 0 35px 7px rgba(255, 255, 224, 0.4)",
    },
  };
